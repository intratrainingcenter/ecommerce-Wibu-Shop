        ...
        <ul class="nav navbar-nav">
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              @else
              <img src="{{Storage::url('images/foto.png')}}" class="user-image" alt="User Image">
              @endif
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="#" data-toggle="modal" data-target="#ProfilUser{{auth::user()->kode_user}}" class="btn btn-default btn-flat">Profile</a>
                </div>
    ...
    <section class="sidebar">
      <ul class="sidebar-menu" data-widget="tree">
        ...
        @if (auth::user()->jabatan == 'Admin')
          ...
          <li><a href="{{route('frontend.pembeli')}}"><i class="fa fa-pie-chart"></i><span>Data Pembeli</span></a></li>
          ...
          <li><a href="{{route('penjualan.index')}}"><i class="fa fa-edit"></i> <span>Data Transaksi Penjualan</span></a></li>
