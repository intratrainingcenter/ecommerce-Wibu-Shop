  ...
  @if($loop->first)
    <tr>
      ...
      <td align="right">
        ...
        @endif|
        <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#ModalStat{{$item->kode_transaksi_pembelian}}"><i class="fa fa-gear"></i></button>
        ...
        @if($item->status == 'Pengajuan' || $item->status == 'Cancelled' || $item->status == 'Done')
