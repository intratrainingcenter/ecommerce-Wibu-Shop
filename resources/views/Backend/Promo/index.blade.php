...
@section('content')
  <div class="content-wrapper">
    <section class="content-header">
      <h1>Promo<small>Control panel</small></h1><ol class="breadcrumb"><li><a href="#"><i class="fa fa-dashboard"></i>Home</a></li><li class="active">Promo</li>  </ol>
    </section>
          ...
          <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box-header">
                    <h3 class="box-title">Data Promo</h3><button class="btn btn-success pull-right" id="ShowModalAdd">Tambah</button>
                </div>
                <div class="box-body">
