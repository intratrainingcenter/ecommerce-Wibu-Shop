                    ...
                    <form role="form" action="{{route('promo.store')}}" method="POST">
                        @csrf @method('POST')
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="kode_promo" id="kode_promoedit" value="" readonly/>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="nama_promo" class="col-md-3">Nama Promo</label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="nama_promo" id="nama_promoedit" value="" required>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-3">
                                <input type="number" name="min" id="minedit" max="99999999" min="0" class="form-control" value="" placeholder="Minimum" required>
                                </div>
                                <div class="col-md-2">
                                    <center><h4>s/d</h4></center>
                                </div>
                                <div class="col-md-3">
                                    <input type="number" name="max" id="maxedit" min="0" max="99999999" class="form-control" value="" placeholder="Maximum" required>
                                </div>
                            </div>
                            <div class="form-group row">
