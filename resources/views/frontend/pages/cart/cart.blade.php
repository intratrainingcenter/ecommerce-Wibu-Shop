        ...
        <div class="goods-page">
          <div class="goods-data clearfix" id="shop-cart">
            ...
            <table summary="Shopping cart">
              ...
              <tr>
                <td class="goods-page-image"> <img src="{{Storage::url($Items->detailProduct->foto)}}"> </td>
                <td class="goods-page-description">
                  <h3><a href="{{route('frontend.shop_item', ['kode_produk' => $Items->kode_produk])}}">{{$Items->detailProduct->nama_produk}}</a></h3>
                </td>
                <td class="goods-page-ref-no"> {{$Items->kode_produk}} </td>
                <td>
                ...
                <td class="goods-page-price" align="right"> <strong><span>Rp.</span>{{number_format($Items->detailProduct->harga)}}</strong> </td>
                <td class="goods-page-total" align="right"> <strong><span>Rp.</span>{{number_format($Items->sub_total)}}</strong> </td>
                <td class="del-goods-col"> <a class="del-goods" href="{{route('frontend.deletecart',$Items->id)}}">&nbsp;</a> </td>
              </tr>
              @empty
                <tr>
            ...
            <div class="shopping-total">
              <ul>
                <li class="shopping-total-price"><em>Grand Total</em><strong class="price"><span>Rp.</span>{{number_format($SUM)}}</strong></li>
              </ul>
            </div>
          </div>
